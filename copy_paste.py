...
def get_download_path():
        ...
        print (full_path)
        return full_path
#Tomove the file from download path to the checkout folder
def move_file(get_download_path,to_path):
    ...
    for i in os.listdir(get_download_path):
        if file_name in i:
            print (i)
            print (to_path+i)
            shutil.copy(os.path.join(get_download_path,i), to_path+i)
